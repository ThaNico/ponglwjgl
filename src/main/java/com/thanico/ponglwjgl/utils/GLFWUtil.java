...
public final class GLFWUtil {
	...
	/**
	 * Invokes the specified callbacks using the current window and framebuffer
	 * sizes of the specified GLFW window.
	 *
	 ...
	 */
	public static void glfwInvoke(long window, GLFWWindowSizeCallbackI windowSizeCB,
